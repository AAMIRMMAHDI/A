                            ...
                            <div>
                                <form action="{site_url}payment/credit" method="post">
									...
									<div class="col-xs-12 centre amountinput amount_box hidden">
										<label class="col-lg-2 col-md-2  col-sm-12 col-xs-12 label" for="Amount" id="labelText">مبلغ به ریال</label>
...
<!--
									<div class="col-xs-12 centre amountinput perfectmoney hidden">
										<label class="col-lg-2 col-md-2  col-sm-12 col-xs-12 label" for="pmmemberid">حساب کاربری پرفکت مانی(ID) </label>
										<input autocomplete="off" class="col-lg-8 col-md-8  col-sm-12 col-xs-12 input ltrinput centre" data-val="true" id="pmmemberid" name="pmmemberid" type="text" value="">
                                	</div>

									<div class="col-xs-12 centre amountinput perfectmoney hidden">
										<label class="col-lg-2 col-md-2  col-sm-12 col-xs-12 label" for="accountusd">حساب کاربری کیف پول (USD) </label>
										<input autocomplete="off" class="col-lg-8 col-md-8  col-sm-12 col-xs-12 input ltrinput centre" data-val="true" id="accountusd" name="accountusd" type="text" value="">
                                	</div>
-->
	...
	<script>
        $(document).ready(function () {
            ...
            $('#ptype').change(function(){
                ...
                if ( method == '42' ){
//                    $(".perfectmoney").removeClass('hidden');
                    $("#labelText").html('');
                    $("#labelText").html('مبلغ به دلار');
                }else{
//                    $(".perfectmoney").addClass('hidden');
                    $("#labelText").html('');
                    $("#labelText").html('مبلغ به ریال');
                }
            });
        });
</script>
