		...
		<div class="inline container">
			...
			<div class="left static-content">
				<div class="page-area container inline form-container">
                        ...
                        <div class="row">
                            <div class="col-lg-12" style="background-color: #333333 !important; text-align: right !important; color: #ffffff !important; padding: 10px 25px 20px 10px !important;">
								<ul>
									...
									<li><b>وضعیت تیکت :</b> {if $ticket->status eq 2}<span class="label label-success" style="width: 200px !important; display: inline-block !important; color: white !important;">پاسخ داده شده</span>{elseif $ticket->status eq 0}<span class="label label-warning" style="width: 200px !important; display: inline-block !important; color: white !important;">منتظر پاسخ</span>{else}<span class="label label-default" style="width: 200px !important; display: inline-block !important; color: white !important;">در حال بررسی</span>{/if}</li>
								</ul>
							</div>
                        </div>
                    </header>
					...
					<div class="row">
						{if $val.user_id != $logged_in_user_id}<div class="col-lg-9" style="margin-top: calc(3.3%) !important; text-align: justify !important; direction: rtl !important;" align="left"><div class="bubblereply">{$val->content}</div></div>{/if}
						<div class="col-lg-3">
							<div class="row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6"><div style="margin-top: 25px !important;">{jdate format='l d F Y' date=$val->created_at}<br>{jdate format='H:i:s' date=$val->created_at}</div></div>
							</div>
						</div>
